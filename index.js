...
const ownerNumber = ['2349120185747']
...
console.log("CONNECTING NONCHALANT-MD 🧬...");
...
console.log('NONCHALANT-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ LITE-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Dami ✅*
...
if(senderNumber.includes("2349120185747")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, NONCHALANT-MD STARTED ✅");
});
